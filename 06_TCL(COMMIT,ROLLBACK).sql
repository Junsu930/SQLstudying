-- TCL(TRANSCATION CONTROL LANGUAGE) : 트랜잭션 제어 언어
-- COMMIT(트랜잭션 종료 후 저장), ROLLBACK(트랜잭션 취소), SAVEPOINT(임시저장);

-- DML(INSERT, UPDATEm DELETE)과 관련되어 있다. 
 ...
 * 
 * 	   INSERT 10번 수행 -> 1개 트랜잭션에 10개 추가 --> ROLLBACK --> DB 반영 안 됨
 *
 *
...
SELECT * FROM DEPARTMENT2; --> COMMIT하였으므로 ROLLBACK 안됨
